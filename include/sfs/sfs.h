...
extern u8 gSfsFirstBlockData[BLOCK_SIZE];
extern u8 gSfsTmpBlock[BLOCK_SIZE];
...
extern synthErrno sfsReadBlocks(u8 *pData, u32 pBlkIdx, u32 pBlkCnt, u32 pByteOffset, u32 pByteCount);
extern synthErrno sfsWriteBlocks(u8 *pData, u32 pBlkIdx, u32 pBlkCnt, u32 pByteOffset, u32 pByteCount);
...
#define sfsReadBlockPartial(dat, blk, count) sfsReadBlocks(dat, blk, 1, 0, count)
...
#define sfsReadSamplesNoInc(dat, blkOrigin, s, cnt) sfsReadBlocksFromOffsetPartial(dat, blkOrigin, (s) * SAMPLE_SIZE, (cnt) * SAMPLE_SIZE)
#define sfsReadSamplesInc(dat, blkOrigin, s, cnt) sfsReadSamplesNoInc(dat, blkOrigin, s, cnt); dat = (typeof((dat)))((u8*)(dat) + (cnt) * SAMPLE_SIZE)
